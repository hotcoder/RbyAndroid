...
public class ThirdScreen extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Button thirdButton = (Button)findViewById(R.id.thridButton);
		
		
		Toast.makeText(getApplicationContext(), ((TextView)findViewById(R.id.thirdText)).getText(), Toast.LENGTH_LONG).show();
